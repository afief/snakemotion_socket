...
(function(){ 'use strict';
	...
	StatePlay.prototype.resize = function() {
		...
		_this.infoElem.style.marginTop = ( -_this.infoElem.offsetHeight / 2 ) + _this.headerHeight / 2 + 'px';
...
(function(){ 'use strict';
	...
	function socketInit() {
		socket.on("connect", function() {
			...
			socket.emit("register", {as: "server"});
		});

		socket.on("reg_success", function(newId) {
			kode.innerHTML = newId.toString();
		});
...
>>>>>>> 04899bb07250da4c0ba23bd52fce6a2328064a43
